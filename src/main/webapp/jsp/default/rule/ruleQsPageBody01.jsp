...
<div class="row">
	<div class="col-lg-12">
		<h3 class="page-header">Rule defined about Verifying Specified Query String <small>for showing all the cases</small></h3>
	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title"><i class="fa fa-table fa-fw"></i>&nbsp;Template for QueryString</h3>
			</div>
			<div class="panel-body">
				...
				<div class="table-responsive">
					<table id="tbl-rule-qs" class="display" width="100%" cellspacing="0">
						<thead>
							<tr>
								...
								<th rowspan="2">QUERY<br>STRING<br>RULE</th>
...
<div class="row">
	<div class="col-lg-12">
		<p><div style="text-align:center"><button id="btnRunAll" type="button" style="width:180px;" class="btn btn-primary btn-lg">Run All</button>&nbsp;<button id="btnRunSelected" type="button" style="width:180px;" class="btn btn-primary btn-lg">Run Selected</button>&nbsp;<a id="btnNewCase" href='<c:url value="/rule/qs/new/form"/>' style="width:180px;" class="btn btn-primary btn-lg">New Case&nbsp;&nbsp;&raquo;</a></div></p>
	</div>
</div>
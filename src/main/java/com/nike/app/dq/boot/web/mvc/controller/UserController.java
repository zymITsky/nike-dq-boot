...
import com.nike.app.dq.boot.common.model.JsonLogonResult;
...
import com.nike.app.dq.boot.util.image.SimpleCaptcha;
import com.nike.app.dq.boot.util.log.SimpleLogger;
import com.nike.app.dq.boot.web.mvc.bean.form.LoginForm;
...
public class UserController {
	...
	public JsonLogonResult loginForUser(@RequestBody @Valid LoginForm loginForm) {
		...
		try {
			...
			UserProfile user = userService.getUserById(currentUserId);

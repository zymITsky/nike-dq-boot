...
<script type="text/javascript" src="<c:url value="/resources/js/mylib/tbl-col-filter.js"/>"></script>
<script type="text/javascript" src="<c:url value="/resources/js/rule/rule_r21fc_01.js"/>"></script>
